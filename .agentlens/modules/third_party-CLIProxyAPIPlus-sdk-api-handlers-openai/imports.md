...
graph TD
    ...
    third_party_CLIProxyAPIPlus_sdk_api_handlers_openai[third_party-CLIProxyAPIPlus-sdk-api-handlers-openai] --> fmt[fmt]
    third_party_CLIProxyAPIPlus_sdk_api_handlers_openai[third_party-CLIProxyAPIPlus-sdk-api-handlers-openai] --> gin[gin]
    third_party_CLIProxyAPIPlus_sdk_api_handlers_openai[third_party-CLIProxyAPIPlus-sdk-api-handlers-openai] --> gjson[gjson]
    ...
    third_party_CLIProxyAPIPlus_sdk_api_handlers_openai[third_party-CLIProxyAPIPlus-sdk-api-handlers-openai] --> strings[strings]
    third_party_CLIProxyAPIPlus_sdk_api_handlers_openai[third_party-CLIProxyAPIPlus-sdk-api-handlers-openai] --> sync[sync]
    third_party_CLIProxyAPIPlus_sdk_api_handlers_openai[third_party-CLIProxyAPIPlus-sdk-api-handlers-openai] --> testing[testing]
    third_party_CLIProxyAPIPlus_sdk_api_handlers_openai[third_party-CLIProxyAPIPlus-sdk-api-handlers-openai] --> thinking[thinking]
    third_party_CLIProxyAPIPlus_sdk_api_handlers_openai[third_party-CLIProxyAPIPlus-sdk-api-handlers-openai] --> time[time]
    third_party_CLIProxyAPIPlus_sdk_api_handlers_openai[third_party-CLIProxyAPIPlus-sdk-api-handlers-openai] --> util[util]
    third_party_CLIProxyAPIPlus_sdk_api_handlers_openai[third_party-CLIProxyAPIPlus-sdk-api-handlers-openai] --> uuid[uuid]
```
