# Module: third_party/CLIProxyAPIPlus/internal/auth/codex
...
| File | Lines | Large |
| ---- | ----- | ----- |
| `third_party/CLIProxyAPIPlus/internal/auth/codex/errors.go` | 171 |  |
| `third_party/CLIProxyAPIPlus/internal/auth/codex/filename.go` | 46 |  |
| `third_party/CLIProxyAPIPlus/internal/auth/codex/html_templates.go` | 214 |  |
