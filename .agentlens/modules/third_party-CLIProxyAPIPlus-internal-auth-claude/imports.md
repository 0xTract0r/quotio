...
```mermaid
graph TD
    third_party_CLIProxyAPIPlus_internal_auth_claude[third_party-CLIProxyAPIPlus-internal-auth-claude] --> base64[base64]
    third_party_CLIProxyAPIPlus_internal_auth_claude[third_party-CLIProxyAPIPlus-internal-auth-claude] --> config[config]
    third_party_CLIProxyAPIPlus_internal_auth_claude[third_party-CLIProxyAPIPlus-internal-auth-claude] --> context[context]
    third_party_CLIProxyAPIPlus_internal_auth_claude[third_party-CLIProxyAPIPlus-internal-auth-claude] --> filepath[filepath]
    third_party_CLIProxyAPIPlus_internal_auth_claude[third_party-CLIProxyAPIPlus-internal-auth-claude] --> fmt[fmt]
    third_party_CLIProxyAPIPlus_internal_auth_claude[third_party-CLIProxyAPIPlus-internal-auth-claude] --> http[http]
    third_party_CLIProxyAPIPlus_internal_auth_claude[third_party-CLIProxyAPIPlus-internal-auth-claude] --> http2[http2]
    third_party_CLIProxyAPIPlus_internal_auth_claude[third_party-CLIProxyAPIPlus-internal-auth-claude] --> io[io]
    third_party_CLIProxyAPIPlus_internal_auth_claude[third_party-CLIProxyAPIPlus-internal-auth-claude] --> json[json]
