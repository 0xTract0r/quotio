# Module: third_party/CLIProxyAPIPlus/internal/thinking
...
| `third_party/CLIProxyAPIPlus/internal/thinking/validate.go` | 391 |  |
...
### `NOTE` (third_party/CLIProxyAPIPlus/internal/thinking/convert.go:161)

> Returns a special sentinel value when modelInfo itself is nil (unknown model).
